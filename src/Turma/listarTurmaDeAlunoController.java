...
public class listarTurmaDeAlunoController implements Initializable {
	...
	public int buscar(String codigo, LinkedList<Aluno> lista) {
	...
	public ObservableList<Turma> getTurmas() {
		...
		if (lista.isEmpty() != true) {
			for (Turma turma : lista) {
				String[] alunos = turma.getAlunos();
				try {
					for(String aluno : alunos) {
						if(aluno.compareToIgnoreCase(cpfAluno.getText())==0) {
							turmas.add(turma);
						}
					}
